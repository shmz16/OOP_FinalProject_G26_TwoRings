 ...
 */
public class CostumerEventManegmenntController implements Initializable {
    ...
    @FXML
    private TextField eventNameTestField;
    @FXML
    private TextField usernametexttield;
    @FXML
    ...
    private void reloadOnClick(ActionEvent event) {
        eventdatepik.setValue(null);
        idTextField.clear();
        textarea.clear();
        eventNameTestField.clear();
        usernametexttield.clear();
    ...
    private void sentButtonOnClick(ActionEvent event) {
        ...
        idTextField.getText();
        textarea.getText();
        eventNameTestField.getText();
        usernametexttield.getText();
        locationtextfield.getText();
        FileOutputStream fos = null;
        ObjectOutputStream oos = null;
        File f = null;
         try {
            f = new File("Customer info to event manegment.bin");
            if (f.exists()) {
