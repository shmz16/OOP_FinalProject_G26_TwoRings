...
public class CEOMeetingController implements Initializable {
    ...
    @FXML
    private void showMeetingTable(ActionEvent event) {
        ObservableList<Meeting> meet = FXCollections.observableArrayList();
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    savedMeeting = (Meeting) ois.readObject();
                    System.out.println("Hi 22");
                    meet.add(savedMeeting);
                    System.out.println(savedMeeting.toString());
